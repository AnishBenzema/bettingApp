                                ...
                                <div class="form-group row">
                                    <div class="col-xs-6" style="padding-right:0px">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" value='3' id="Race1TxtBoxID" name="NewRace1TxtBox" readonly>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <table class="table table-bordered table-striped dt-responsive tables" id="horsetableRace1">
                        ...
                        <tbody>
                            <?php
                                ...
                                $TotalAmtBet = HorseController::ctrShowTotalAmoutBetRace3();
